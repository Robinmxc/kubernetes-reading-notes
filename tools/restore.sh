...
function pg_restore(){
	  ...
	  remote_ssh_command ${to_ip} ${to_password} "${kube_cp};${kube_cp_2};${kube_cp_3};${restore_command_del};${restore_command_del_2};${restore_command_del_3};${restore_command};${restore_command_2};${restore_command_3};${del_command};" 
}
